...
commandHandler(sqlite3 *db, char *idElection, Commande cmd) {
    switch(cmd.type) {
        case AJOUT_ELECTION:
            handlerAjoutElection(db, idElection);
            break;
